...
add_action('widgets_init', 'wallstreet_agency_widgets_init');
   
function wallstreet_agency_widgets_init() {
    register_sidebar(array(
        'name' => esc_html__('Footer widget area', 'wallstreet-agency'),
        'id' => 'footer-widget-area',
        'description' => esc_html__('Footer widget area', 'wallstreet-agency'),

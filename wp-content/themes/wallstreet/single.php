        ...
        ?>" >
                 ...
                 if (have_posts()) {
                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class('blog-detail-section'); ?>>
						...
						<div class="btn-block flex_btn">
							<?php previous_post_link( '%link', '<div class="btn btn-default"><span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'brunelleschi' ) . '</span> %title</div>' ); ?>
							<?php next_post_link( '%link', '<div class="btn btn-default">%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'brunelleschi' ) . '</span></div>' ); ?>
						</div>
                    </div>
